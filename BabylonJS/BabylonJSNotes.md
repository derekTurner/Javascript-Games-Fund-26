...
[BabylonJS](https://www.babylonjs.com/) is now in version 9.
[Vite development server](https://vite.dev/) is in version 8

I will attempt to use [BUN](https://bun.sh/) as the javascript runtime. Try without Vite.
